...
async def async_setup_entry(
    ...
    if flows:
        ...
        for flow_id, flow in flows.items():
            ...
            if flow_enabled:
                enabled_flows += 1
                entities.append(HomeyFlowButton(coordinator, flow_id, flow, api, homey_id))
        ...
        for capability_id in capabilities:
            ...
            if is_button:
                ...
                if capability_obj.get("setable"):
                    entities.append(HomeyDeviceButton(coordinator, device_id, device, capability_id, api, zones, homey_id))
...
class HomeyFlowButton(CoordinatorEntity, ButtonEntity):
    ...
    def __init__(
        ...
        flows_identifier = f"{homey_id}:flows" if homey_id else "flows"
